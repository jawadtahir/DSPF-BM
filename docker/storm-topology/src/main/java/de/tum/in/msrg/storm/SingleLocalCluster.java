 ...
 */
public class SingleLocalCluster implements ILocalClusterTrackedTopologyAware, Iface {
    public static final KillOptions KILL_NOW = new KillOptions();
    private static final Logger LOG = LoggerFactory.getLogger(SingleLocalCluster.class);
     ...
     */
    public SingleLocalCluster() throws Exception {
        this(new Builder().withDaemonConf(Config.TOPOLOGY_ENABLE_MESSAGE_TIMEOUTS, true).withSupervisors(2).withPortsPerSupervisor(1));
    }
     ...
     * @throws Exception on any error
     */
    public SingleLocalCluster(String zkHost, Long zkPort) throws Exception {
    ...
    private SingleLocalCluster(Builder builder) throws Exception {
    ...
    public static <T> T withLocalModeOverride(Callable<T> c, long ttlSec, Map<String, Object> daemonConf) throws Exception {
        ...
        try (SingleLocalCluster local = builder.build();
    ...
    public static class Builder {
         ...
         */
        public SingleLocalCluster build() throws Exception {
            return new SingleLocalCluster(this);
        }
    }
