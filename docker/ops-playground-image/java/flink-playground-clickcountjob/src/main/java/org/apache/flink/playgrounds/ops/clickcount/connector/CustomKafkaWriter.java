 ...
 */
class CustomKafkaWriter<IN> implements SinkWriter<IN, KafkaCommittable, KafkaWriterState> {

    private static final Logger LOG = LoggerFactory.getLogger(CustomKafkaWriter.class);
    ...
    CustomKafkaWriter(
        ...
        this.throughputMeter = sinkInitContext.metricGroup().meter("flinkRecordsProduced", new MeterView(1));
        initFlinkMetrics();
    }
        ...
        public void onCompletion(RecordMetadata metadata, Exception exception) {
            if (exception != null) {
                FlinkKafkaInternalProducer<byte[], byte[]> producer =
                        CustomKafkaWriter.this.currentProducer;
