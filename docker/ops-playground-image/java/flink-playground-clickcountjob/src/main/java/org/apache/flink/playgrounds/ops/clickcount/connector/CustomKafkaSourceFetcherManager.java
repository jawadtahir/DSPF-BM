 ...
 * CustomKafkaPartitionSplitReader}.
 */
public class CustomKafkaSourceFetcherManager
        extends SingleThreadFetcherManager<ConsumerRecord<byte[], byte[]>, KafkaPartitionSplit> {
    private static final Logger LOG = LoggerFactory.getLogger(CustomKafkaSourceFetcherManager.class);
     ...
     */
    public CustomKafkaSourceFetcherManager(
    ...
    private void enqueueOffsetsCommitTask(
        ...
        CustomKafkaPartitionSplitReader kafkaReader =
                (CustomKafkaPartitionSplitReader) splitFetcher.getSplitReader();
