...
package org.apache.flink.playgrounds.ops.clickcount.connector;
 ...
 * KafkaSource.
 */
public class CustomKafkaSourceBuilder<OUT> {
    private static final Logger LOG = LoggerFactory.getLogger(CustomKafkaSourceBuilder.class);
     ...
     */
    public CustomKafkaSourceBuilder<OUT> setBootstrapServers(String bootstrapServers) {
     ...
     * @return this KafkaSourceBuilder.
     */
    public CustomKafkaSourceBuilder<OUT> setGroupId(String groupId) {
     ...
     */
    public CustomKafkaSourceBuilder<OUT> setTopics(List<String> topics) {
     ...
     * @see org.apache.kafka.clients.consumer.KafkaConsumer#subscribe(Collection)
     */
    public CustomKafkaSourceBuilder<OUT> setTopics(String... topics) {
     ...
     */
    public CustomKafkaSourceBuilder<OUT> setTopicPattern(Pattern topicPattern) {
     ...
     */
    public CustomKafkaSourceBuilder<OUT> setPartitions(Set<TopicPartition> partitions) {
     ...
     * @return this KafkaSourceBuilder.
     */
    public CustomKafkaSourceBuilder<OUT> setStartingOffsets(
     ...
     */
    public CustomKafkaSourceBuilder<OUT> setUnbounded(OffsetsInitializer stoppingOffsetsInitializer) {
        this.boundedness = Boundedness.CONTINUOUS_UNBOUNDED;
     ...
     */
    public CustomKafkaSourceBuilder<OUT> setBounded(OffsetsInitializer stoppingOffsetsInitializer) {
     ...
     * @return this KafkaSourceBuilder.
     */
    public CustomKafkaSourceBuilder<OUT> setDeserializer(
     ...
     * @return this KafkaSourceBuilder.
     */
    public CustomKafkaSourceBuilder<OUT> setValueOnlyDeserializer(
     ...
     * @return this KafkaSourceBuilder.
     */
    public CustomKafkaSourceBuilder<OUT> setClientIdPrefix(String prefix) {
     ...
     * @return this KafkaSourceBuilder.
     */
    public CustomKafkaSourceBuilder<OUT> setProperty(String key, String value) {
     ...
     * @return this KafkaSourceBuilder.
     */
    public CustomKafkaSourceBuilder<OUT> setProperties(Properties props) {
     ...
     */
    public CustomKafkaSource<OUT> build() {
        sanityCheck();
        parseAndSetRequiredProperties();
        return new CustomKafkaSource<>(
                subscriber,
