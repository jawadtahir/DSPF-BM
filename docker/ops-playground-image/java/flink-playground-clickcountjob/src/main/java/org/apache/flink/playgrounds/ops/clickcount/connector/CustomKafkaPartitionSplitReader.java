...
public class CustomKafkaPartitionSplitReader
        implements SplitReader<ConsumerRecord<byte[], byte[]>, KafkaPartitionSplit> {
    private static final Logger LOG = LoggerFactory.getLogger(CustomKafkaPartitionSplitReader.class);
    ...
    public CustomKafkaPartitionSplitReader(
            Properties props,
    ...
    public RecordsWithSplitIds<ConsumerRecord<byte[], byte[]>> fetch() throws IOException {
        ...
        this.throughputMeter.markEvent(consumerRecords.count());
