...
/**
 * Builder to construct {@link CustomKafkaSink}.
 *
 ...
 *
 * @see CustomKafkaSink for a more detailed explanation of the different guarantees.
 * @param <IN> type of the records written to Kafka
 */
@PublicEvolving
public class CustomKafkaSinkBuilder<IN> {

    private static final Logger LOG = LoggerFactory.getLogger(CustomKafkaSinkBuilder.class);
     ...
     * @return {@link CustomKafkaSinkBuilder}
     */
    public CustomKafkaSinkBuilder<IN> setDeliverGuarantee(DeliveryGuarantee deliveryGuarantee) {
     ...
     * @return {@link CustomKafkaSinkBuilder}
     */
    public CustomKafkaSinkBuilder<IN> setKafkaProducerConfig(Properties kafkaProducerConfig) {
     ...
     * @return {@link CustomKafkaSinkBuilder}
     */
    public CustomKafkaSinkBuilder<IN> setRecordSerializer(
     ...
     * @return {@link CustomKafkaSinkBuilder}
     */
    public CustomKafkaSinkBuilder<IN> setTransactionalIdPrefix(String transactionalIdPrefix) {
     ...
     * @return {@link CustomKafkaSinkBuilder}
     */
    public CustomKafkaSinkBuilder<IN> setBootstrapServers(String bootstrapServers) {
        this.bootstrapServers = checkNotNull(bootstrapServers);
        return this;
    }

    /**
     * Constructs the {@link CustomKafkaSink} with the configured properties.
     *
     * @return {@link CustomKafkaSink}
     */
    public CustomKafkaSink<IN> build() {
