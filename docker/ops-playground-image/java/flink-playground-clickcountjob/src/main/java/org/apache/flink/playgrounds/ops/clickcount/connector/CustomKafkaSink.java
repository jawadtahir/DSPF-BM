 ...
 * @see CustomKafkaSinkBuilder on how to construct a KafkaSink
 */
@PublicEvolving
public class CustomKafkaSink<IN> implements Sink<IN, KafkaCommittable, KafkaWriterState, Void> {
    ...
    /**
     * Create a {@link CustomKafkaSinkBuilder} to construct a new {@link CustomKafkaSink}.
     *
     * @param <IN> type of incoming records
     * @return {@link CustomKafkaSinkBuilder}
     */
    public static <IN> CustomKafkaSinkBuilder<IN> builder() {
        return new CustomKafkaSinkBuilder<>();
    }
