...
public class CustomKafkaSourceReader<T>
        extends SingleThreadMultiplexSourceReaderBase<
                ConsumerRecord<byte[], byte[]>, T, KafkaPartitionSplit, KafkaPartitionSplitState> {
    private static final Logger LOG = LoggerFactory.getLogger(CustomKafkaSourceReader.class);
    ...
    public CustomKafkaSourceReader(
            FutureCompletingBlockingQueue<RecordsWithSplitIds<ConsumerRecord<byte[], byte[]>>>
                    elementsQueue,
            CustomKafkaSourceFetcherManager kafkaSourceFetcherManager,
    ...
    public void notifyCheckpointComplete(long checkpointId) throws Exception {
        ...
        ((CustomKafkaSourceFetcherManager) splitFetcherManager)
                .commitOffsets(
                        committedPartitions,
                        (ignored, e) -> {
